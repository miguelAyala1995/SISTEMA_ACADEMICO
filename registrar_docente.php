...
<head>
  ...
  <title>Registrar docente - IESTPHUANTA  </title>
                        ...
                        <div class="x_content">
                          <form class="form-horizontal form-label-left" action="./operaciones/resgistrar_docente.php" method="POST" id="formulario_docente">
                            ...
                            <div class="item form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="email" name="nombre" required="" placeholder="Ingrese sus nombres y apellidos" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="number" name="direccion" required="" placeholder="Ingrese su dirección"  data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="item form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="email" id="website" name="correo" required="" placeholder="Ingrese su correo electrónico"  class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="item form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input id="occupation" type="number" name="telefono" data-validate-length-range="5,20" class="optional form-control col-md-7 col-xs-12 telefono" placeholder="990 334 882" id="telefono" maxlength="9" />
                              </div>
                            </div>
                            <div class="item form-group">
