                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <br />
                                <form class="form-horizontal form-label-left" method="POST" action="operaciones/registrar_unidad_didactica.php" required>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            while ($resultado_buscar_programa = mysqli_fetch_array($buscar_programa)) {
                                            ?> 
                                            <option value="<?php echo $resultado_buscar_programa['id']?>"> <?php echo $resultado_buscar_programa['nombre']?> </option>
                                            <?php
                                            }
                                            ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            while ($resultado_buscar_modulo = mysqli_fetch_array($buscar_modulo)) {
                                            ?> 
                                            <option value="<?php echo $resultado_buscar_modulo['id']?>"> <?php echo $resultado_buscar_modulo['descripcion']?> </option>
                                            <?php
                                            }
                                            ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            while ($resultado_buscar_semestre= mysqli_fetch_array($buscar_semestre)) {
                                            ?> 
                                            <option value="<?php 
                                            echo $resultado_buscar_semestre['id']?>"> <?php echo $resultado_buscar_semestre['descripcion']?> </option>
                                            <?php
                                            }
                                            ?>
                                            </select>
