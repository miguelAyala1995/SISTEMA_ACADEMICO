...
$buscar_condicion = buscarCondicionById($conexion, $id_condicion);
$resultado_buscar_condicion = mysqli_fetch_array($buscar_condicion);
?>
<!DOCTYPE html>
<html lang="en">
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo $id_condicion;?>">
                                                        ...
                                                        <div class="item form-group">
                                                            ...
                                                            <input type="text" name="condicion" class="date-picker form-control col-md-7 col-xs-12" value="<?php echo $resultado_buscar_condicion['descripcion']; ?>">
                                                            </div>
                                                        </div>
                                                        <br><br>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                                <a href="./condicion.php" class="btn btn-primary" type="button">Cancelar</a>
