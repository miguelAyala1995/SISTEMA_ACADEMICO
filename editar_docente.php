...
$resultado_busqueda_docente = mysqli_fetch_array($buscar_docente);
...
<head>
	...
	<title>Editar docente - IESTPHUANTA </title>
	<!-- Bootstrap -->
								...
								<form class="form-horizontal form-label-left" method="POST" action="operaciones/actualizar_docente.php">
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="number" name="dni" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['dni']; ?>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="text" name="apellidos_nombres" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['apellidos_nombres']; ?>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="date" name="fecha_nac" class="date-picker form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['fecha_nac']; ?>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="text" name="direccion" class="form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['direccion']; ?>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="email" name="correo" class="form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['correo']; ?>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="number" name="telefono" maxlength="9" class="form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['telefono']; ?>">
										</div>
									</div>
									<div class="form-group">
										<label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Genero :</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<select name="id_genero" id="id_genero" class="form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['id_genero']; ?>">
												<option value="">Seleccione</option>
												<?php
												$id_genero_docente = $resultado_busqueda_docente['id_genero'];
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input name="nivel_educacion" id="nivel_educacion" class="form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['nivel_educacion']; ?>">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input name="cond_laboral" id="cond_laboral" class="form-control col-md-7 col-xs-12" value="<?php echo $resultado_busqueda_docente['cond_laboral']; ?>">
										</div>
									</div>
									<div class="form-group">
